package com.sa.padc_x_customviewcomponent_sa.views.components
...
// represent the available fan speeds.
...
class DialView @JvmOverloads constructor(
    ...
    override fun onSizeChanged(wight: Int, height: Int, oldWidth: Int, oldHeight: Int) {
        radius = (min(wight, height) / 2.0 * 0.8).toFloat()
    }
